...
W_MenuStart_v1::W_MenuStart_v1(QWidget *parent) :
    QWidget(parent)
{
...
void W_MenuStart_v1::loadGame(QString value)
{
    qDebug() << "LOAD";
    ...
    G_Profil_v1* user = new G_Profil_v1();
...
void W_MenuStart_v1::newGameForm()
{
    if (totalForms < maxTotalForms)
    {
        buttonNew->hide();
...
void W_MenuStart_v1::newGame()
{
//    qDebug() << "NEW";
    if (username->text() != "")
    {
        G_Profil_v1* newProfil = new G_Profil_v1();
...
void W_MenuStart_v1::saveGame(G_Profil_v1* currentUser)
{
    qDebug() << "SAVE";
