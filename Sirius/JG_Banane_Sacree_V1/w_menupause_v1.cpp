...
W_MenuPause_v1::W_MenuPause_v1(QWidget *parent)
{
    this->setStyleSheet(
                        "text-align: center;"
                        "color: #2e2e2e;"
...
QGraphicsDropShadowEffect* W_MenuPause_v1::shadowbtn()
{
...
void W_MenuPause_v1::paintEvent(QPaintEvent *pe)
{
  QStyleOption o;
  o.initFrom(this);
  QPainter p(this);
...
void W_MenuPause_v1::setUnableMenu(int levelValue)
{
