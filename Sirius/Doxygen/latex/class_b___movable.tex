...
\item[\hyperlink{todo__todo000001}{Todo}]integrate with D\+P Factoryx \end{DoxyRefDesc}
...
Check if the block can move to the bottom. 
...
Check if the block can move to the top. 
...
\begin{DoxyReturn}{Returns}
true if it collides with a specific block.
\end{DoxyReturn}
...
Set the position of the object with the x and y values. 
